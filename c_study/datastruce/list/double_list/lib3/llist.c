...
int llist_insert(struct llist_head *llist, const void *data, int mode);
void *llist_find(struct llist_head *llist, const void *key, llist_cmp * cmp);
int llist_delete(struct llist_head *llist, const void *key, llist_cmp *cmp);
int llist_fetch(struct llist_head *llist, const void *key, llist_cmp *cmp, void *data);
void llist_travel(struct llist_head *llist, llist_op *print_op);
